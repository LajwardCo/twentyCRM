...
@Injectable()
@WorkspaceQueryHook(`surveyCampaign.createOne`)
export class SurveyCampaignCreateOnePreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    return {
      ...payload,
      data: this.surveyWriteGuardService.prepareCampaignCreate(
