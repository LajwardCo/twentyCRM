...
@Injectable()
@WorkspaceQueryHook(`surveyForm.createOne`)
export class SurveyFormCreateOnePreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    return {
      ...payload,
      data: this.surveyWriteGuardService.prepareFormCreate(
        authContext,
