...
@Injectable()
@WorkspaceQueryHook(`surveyForm.deleteMany`)
export class SurveyFormDeleteManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  execute(
    ...
    return this.surveyWriteGuardService.rejectDirectWrite('surveyForm');
  }
}
