...
@Injectable()
@WorkspaceQueryHook(`surveyForm.updateOne`)
export class SurveyFormUpdateOnePreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    return {
      ...payload,
      data: (await this.surveyWriteGuardService.prepareFormUpdate(
        authContext,
        payload.id,
