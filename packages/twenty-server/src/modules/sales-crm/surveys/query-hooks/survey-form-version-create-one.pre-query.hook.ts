...
@Injectable()
@WorkspaceQueryHook(`surveyFormVersion.createOne`)
export class SurveyFormVersionCreateOnePreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  execute(
    ...
    _objectName: string,
    _payload: CreateOneResolverArgs,
  ): never {
