...
@Injectable()
@WorkspaceQueryHook(`surveyFormVersion.updateMany`)
export class SurveyFormVersionUpdateManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  execute(
    ...
    _objectName: string,
    _payload: UpdateManyResolverArgs,
  ): never {
