...
@Injectable()
@WorkspaceQueryHook(`surveyInvitation.updateMany`)
export class SurveyInvitationUpdateManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    this.surveyWriteGuardService.assertInvitationUpdate(
