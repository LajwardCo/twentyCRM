...
@Injectable()
@WorkspaceQueryHook(`surveyResponse.updateMany`)
export class SurveyResponseUpdateManyPreQueryHook implements WorkspacePreQueryHookInstance {
  constructor(
  ...
  async execute(
    ...
    this.surveyWriteGuardService.assertResponseUpdateMany(
